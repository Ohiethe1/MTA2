...
const SupervisorFormUpload = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('http://localhost:8000/upload/supervisor', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-lg mt-10">
      <h2 className="text-3xl font-extrabold text-gray-900 mb-2 text-center">Upload Overtime Authorization Form (Supervisors)</h2>
      <p className="text-gray-500 text-center mb-8">Upload your form file for supervisors. Our AI will extract all the details automatically.</p>
...
export default SupervisorFormUpload; 